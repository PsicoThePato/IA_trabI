...
def step(estado_atual, temp, k):
    ...
    potential_state = estado_atual.copy()
        ...
        #     potential_state.index,
        #     (int(len(potential_state) * factor) + 1),
        #     replace=False
        # )
    ...
    #print(potential_state.loc[pior_ponto, 'C-grupo'])
    #print(len(potential_state.loc[potential_state['C-grupo'] == pior_grp]))
